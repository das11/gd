...
IOWA.CountdownTimer.Core = function(t, e) {
    ...
    this.countdownMargin = 50, this.bandGutter = 40, this.bandPadding = 8, this.strokeWeight = 3, this.pixelRatio = window.devicePixelRatio, this.unitsAdded = !1, this.drawAll = !1, this.posShift = 0, this.digits = [], this.onVisibilityChange = this.onVisibilityChange.bind(this), this.onResize = this.onResize.bind(this), this.onMouseMove = this.onMouseMove.bind(this), this.onFrame = this.onFrame.bind(this)
};
...
IOWA.CountdownTimer.Core.prototype.checkTime = function() {
    ...
    if (this.firstRun) {
        var e = t.days + " days, " + t.hours + " hours, " + t.minutes + " minutes, " + t.seconds + " seconds until Guwahati Diaries";
